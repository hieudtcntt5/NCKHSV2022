...
directory = r'D:/hieu_dt/Nam3_KI_2/NCKH\Br35H-Mask-RCNN/code'
with open('D:/hieu_dt/Nam3_KI_2/NCKH\Br35H-Mask-RCNN/TRAIN/annotations_train.json') as json_file:
    data = json.load(json_file)
# loading images
images_path = "D:/hieu_dt/Nam3_KI_2/NCKH/Br35H-Mask-RCNN/TRAIN/"
train_images = glob.glob(images_path + "*.jpg")

for img in train_images:
   image = cv2.imread(img)
   dimensions = image.shape
   file_name = str(img).replace("D:/hieu_dt/Nam3_KI_2/NCKH/Br35H-Mask-RCNN/TRAIN/", "")
